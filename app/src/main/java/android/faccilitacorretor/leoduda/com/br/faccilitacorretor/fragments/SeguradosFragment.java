...
import android.faccilitacorretor.leoduda.com.br.faccilitacorretor.adapters.SeguradoAdapter;
 ...
 */
public class SeguradosFragment extends Fragment {
    private RecyclerView seguradoRecyclerView;
    private SeguradoAdapter seguradoAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_segurados, container, false);
        seguradoAdapter = new SeguradoAdapter(this.getActivity().getApplicationContext(), segurados, this.getActivity());
        seguradoRecyclerView = (RecyclerView) view.findViewById(R.id.seguradoListRecyclerView);
        seguradoRecyclerView.setAdapter(seguradoAdapter);
        seguradoRecyclerView.setItemAnimator(new DefaultItemAnimator());
        seguradoRecyclerView.setLayoutManager(new LinearLayoutManager(this.getActivity().getApplicationContext()));
