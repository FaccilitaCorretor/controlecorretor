...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Buscando dados das apolices
        apoliceDAO = new ApoliceDAO(getActivity().getApplicationContext());
        ydata = apoliceDAO.getTopVendasSeguradoras();
        xData = apoliceDAO.getTopSeguradoras();

        mChart = (PieChart)view.findViewById(R.id.mChart);

        //adicionando o gráfico de pizza ao layout
